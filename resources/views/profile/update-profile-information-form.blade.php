        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    ...
                    <img src="{{ Auth::user()->profile_photo_path != null ? asset('storage/'.Auth::user()->profile_photo_path) : asset('storage/nopic.png')}}" alt="{{ $this->user->name }}" class="object-cover w-20 h-20 rounded-full">
